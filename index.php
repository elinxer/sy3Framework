...
define("CACHE_PATH", ROOT_PATH . '/storage/cache'); // 缓存目录
...
$framework = new Symfony\Component\HttpKernel\HttpCache\HttpCache(
    new \Framework\Framework($container),
    new Symfony\Component\HttpKernel\HttpCache\Store(CACHE_PATH)
);

//$framework = new \Framework\Framework($container);
